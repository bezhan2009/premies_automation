...
const (
	PollService_CreateDOCXPoll_FullMethodName = "/PollService/CreateDOCXPoll"
)
...
type PollServiceClient interface {
	CreateDOCXPoll(ctx context.Context, in *CreateDOCXPollRequest, opts ...grpc.CallOption) (*CreateDOCXPollResponse, error)
}
...
func (c *pollServiceClient) CreateDOCXPoll(ctx context.Context, in *CreateDOCXPollRequest, opts ...grpc.CallOption) (*CreateDOCXPollResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateDOCXPollResponse)
	err := c.cc.Invoke(ctx, PollService_CreateDOCXPoll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PollServiceServer interface {
	CreateDOCXPoll(context.Context, *CreateDOCXPollRequest) (*CreateDOCXPollResponse, error)
...
func (UnimplementedPollServiceServer) CreateDOCXPoll(context.Context, *CreateDOCXPollRequest) (*CreateDOCXPollResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDOCXPoll not implemented")
}
...
func _PollService_CreateDOCXPoll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDOCXPollRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PollServiceServer).CreateDOCXPoll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PollService_CreateDOCXPoll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PollServiceServer).CreateDOCXPoll(ctx, req.(*CreateDOCXPollRequest))
	}
...
var PollService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateDOCXPoll",
			Handler:    _PollService_CreateDOCXPoll_Handler,
		},
	},
